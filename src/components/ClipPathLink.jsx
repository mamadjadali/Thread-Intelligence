...
import { SiC, SiCplusplus, SiNextdotjs, SiRust } from "react-icons/si";
  ...
  return (
    <div className="divide-y rounded-xl divide-neutral-900 border border-neutral-900">
      <div className="grid grid-cols-2 divide-x divide-neutral-900">
        <LinkBox Icon={SiC} href="#" />
        <LinkBox Icon={SiCplusplus} href="#" />
      </div>
      <div className="grid grid-cols-4 divide-x divide-neutral-900">
        <LinkBox Icon={RiJavascriptFill} href="#" />
        <LinkBox Icon={BiLogoTypescript} href="#" />
        <LinkBox Icon={SiRust} href="#" />
        <LinkBox Icon={FaPython} href="#" />
      </div>
      <div className="grid grid-cols-3 divide-x divide-neutral-900">
        <LinkBox Icon={FaReact} href="#" />
        <LinkBox Icon={SiNextdotjs} href="#" />
        <LinkBox Icon={LiaNode} href="#" />
      </div>
    </div>
  );
};
...
const LinkBox = ({ Icon, href }) => {
  ...
  return (
    ...
    >
      <Icon className="text-2xl sm:text-4xl lg:text-4xl" />
